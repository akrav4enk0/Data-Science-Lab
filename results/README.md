...
- [`terminal-bench_analysis.png`](https://github.com/akrav4enk0/Data-Science-Lab/blob/main/results/terminal-bench/terminal-bench_analysis.png) - visualization of the `terminalbench_summary.csv` shown as `plot_terminalbench_results.py`.
