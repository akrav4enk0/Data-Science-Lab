...
- `terminal-bench_analysis.png` - visualization of the `terminalbench_summary.csv` shown as `plot_terminalbench_results.py`. The code is in [/scripts/terminal-bench] (https://github.com/akrav4enk0/Data-Science-Lab/tree/main/scripts/terminal-bench) . 
