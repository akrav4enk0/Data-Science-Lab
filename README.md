...
## Run Evaluation
### Terminal-bench
Terminal-Bench requires Docker to run containerized coding tasks.See [docs/terminal-bench-guide.md](https://github.com/akrav4enk0/Data-Science-Lab/blob/main/docs/terminal-bench-guide.md) for more details.
